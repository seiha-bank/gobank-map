...
function createPopup(currentFeature) {
  ...
  const popup = new mapboxgl.Popup({ closeOnClick: true })
    ...
    .setHTML("<h3>" + currentFeature.properties[config.popupInfo] + "</h3>" + "<p>" + currentFeature.properties[config.popupContact] + "</p>" + "<p><a href=" + currentFeature.properties[config.popupDescription] + ">" + 'Website' + "</a></p>")  
    .addTo(map);
}
...
function buildLocationList(locationData) {
  ...
  locationData.features.forEach(function (location, i) {
    ...
    link.addEventListener("click", function () {
      ...
      flyToLocation(clickedListing, 17.25);
    ...
    csv2geojson.csv2geojson(csvData, {
      ...
      map.addLayer({
        ...
        "paint": {
          ...
          "circle-color": "#33C244", // color of circles
